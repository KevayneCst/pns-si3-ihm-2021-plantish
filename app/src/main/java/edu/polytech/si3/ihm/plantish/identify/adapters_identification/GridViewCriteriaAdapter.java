...
public class GridViewCriteriaAdapter extends ArrayAdapter<Criterion> {
    private Context context;

    public GridViewCriteriaAdapter(Context context, int resource, List<Criterion> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (null == v) {
            ...
            v = inflater.inflate(R.layout.criterion_grid_item, null);
        }
