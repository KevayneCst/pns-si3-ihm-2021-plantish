...
public class ListViewPlantFoundAdapter extends ArrayAdapter<PlantFound> {

    private Context context;

    public ListViewPlantFoundAdapter(Context context, int resource, List<PlantFound> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (null == v) {
            ...
            v = inflater.inflate(R.layout.plant_found_list_item, null);
        }
